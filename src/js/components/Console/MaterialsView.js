...
export default class MaterialTable extends React.Component {
  ...
  constructor() {
    ...
    this.state = {
      mode: "view",
      modes: ["view", "edit"],
      editMaterial: "A/C Complete Unit",
  ...
  render() {
    ...
    const materials = this.state.materials.map((material) => {
      if(this.state.mode == "edit" && this.state.editMaterial.toUpperCase() == material.title.toUpperCase()) {
        if(material.proofOfOwnership == "true") {
          return (
            <tr class="danger-custom" key={material.title}>
              <td><input type="text" value={material.title + "*"} /></td>
